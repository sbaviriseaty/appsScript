var slideTemplateId = "1YKSAeWA6ONnhV3Qk2979wjPXSGTvH5XrIHT3NX3FnOs"; // Sample: https://docs.google.com/spreadsheets/d/1cgK1UETpMF5HWaXfRE6c0iphWHhl7v-dQ81ikFtkIVk
var tempFolderId = "11CayFlTBKs8KR09JX1IxncR_sj-fiG8A"; // Create an empty folder in Google Drive
...
function createCertificates() {
  ...
  for (var i = 1; i < values.length; i++) {
    ...
    sheet.getRange(i + 1, statusIndex + 1 + 1).setValue("https://docs.google.com/presentation/d/" + empSlideId);
...
function sendCertificates() {
  ...
  for (var i = 1; i < values.length; i++) {
    ...
    var senderName = "University of Florida Science Olympiad";
    var subject = empName + ", you're awesome!";
    var body = "Please find your digital thank you card attached."
    + "\n\n" + "From our 2021 Regional Tournament Directors";
